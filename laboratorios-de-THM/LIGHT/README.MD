...
![Conexión inicial vía netcat](screenshots/01.png)
...
![Intento fallido de login SSH](screenshots/02.png)
...
![Prueba de comilla simple](screenshots/03.png)
...
![Filtro de palabras detectado](screenshots/06.png)
...
![Prueba con Union capitalizado](screenshots/07.png)

```
smokey 'Select'
```

![Prueba con Select filtrado](screenshots/08.png)
...
![Respuesta vacía tras bypass de filtro](screenshots/09.png)
...
![Nombre de tabla obtenido](screenshots/10.png)
...
![Estructura de la tabla admintable](screenshots/11.png)
...
![Error al extraer todos los registros](screenshots/12.png)
...
![Conteo de registros: 2 usuarios](screenshots/13.png)
...
![Usuario TryHackMeAdmin obtenido](screenshots/14.png)
...
![Segundo usuario: flag](screenshots/15.png)
...
![Flag del laboratorio obtenida](screenshots/16.png)
...
![Contraseña de TryHackMeAdmin](screenshots/17.png)
